    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher_role', models.CharField(choices=[('Professor', 'Professor'), ('Asst. Professor', 'Asst. Professor'), ('HOD', 'HOD'), ('DC', 'DC')], default='Professor', max_length=100, verbose_name='Teacher Role')),
