    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_phone_number', models.CharField(max_length=20, verbose_name='Parent Ph. No.')),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=10, verbose_name='Gender')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('student_type', models.CharField(choices=[('Mgmt', 'Management'), ('Govt', 'Govt')], default='Mgmt', max_length=10)),
                ('degree_type', models.CharField(choices=[('UG', 'UG'), ('PG', 'PG')], default='UG', max_length=10)),
